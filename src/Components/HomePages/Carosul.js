...
const Carosul = () => {
    return (
        <div>
            <div className=''>
                <div className='bg-indigo-50 md:flex rounded-xl py-5 md:gap-80'>
                    <div className='w-4/12 md:mt-7 md:ml-5'>
                        <div className="carousel">
                            <div id="item1" className="carousel-item">
                                <img src={carosul} className="h-48" />
                            </div>
                            <div id="item2" className="carousel-item">
                                <img src={carosu2} className="h-48" />
                            </div>
                            <div id="item3" className="carousel-item">
                                <img src={carosu3} className="h-48" />
                            </div>
                            <div id="item4" className="carousel-item">
                                <img src={carosu4} className="h-48" />
                            </div>
                        </div>
                    ...
                    <div className='w-4/12 md:mt-24 md:mr-3 text-justify md:ml-7'>
