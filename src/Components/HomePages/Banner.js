            ...
            <div className="hero min-h-fit bg-indigo-50 pt-10 " style={{ backgroundImage: `url(${banner})` }}>
                <div className="hero-content text-center bg-opacity-5">
                    <div className=" text-left mt-10 ml-0">
                        ...
                        <p className="py-1 px-1  bg-slate-300">Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
                    </div>
                </div>
            </div>
        </div>
