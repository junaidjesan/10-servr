            ...
            <form onSubmit={handleOnSubmit}>
                <div className="form-control w-full py-20 gap-5">
                    <div className='w-full md:w-7/12 mx-auto'>
                        ...
                        <input onBlur={handleOnBlur} type="url" required name='img' placeholder="Image http://" className="input input-bordered w-full " />
                    </div>
                    ...
                    <div>
                    <button onClick={notify} className='py-3 px-2 w-4/12 mx-auto border-separate bg-cyan-800 rounded-lg text-white'>Add New</button>
                    <ToastContainer
                        position="top-center"
                        autoClose={4000}
